            ...
            <div className="container h-100">
                <div className="row h-100 align-items-center justify-content-center">
                    ...
                    <div className="col-md-5 mb-4 mb-md-0 d-flex flex-column align-items-center justify-content-center">
                        ...
                        <h1 className="mt-3 text-center" style={{ fontFamily: 'Cambria, Cochin, Georgia, Times, serif', color: '#002d62' }}>
                            Inventory Management System
                        </h1>
                        <p className="text-center" style={{ color: '#002d62' }}>
                    ...
                    <div className="col-md-5">
                        <div className="p-4 rounded-3 shadow-lg w-100"
                             style={{ 
                                 background: 'rgba(255, 255, 255, 0.1)', 
                                 backdropFilter: 'blur(10px)', 
                                 border: '2px solid rgba(255, 255, 255, 0.3)' 
                             }}>
                            <h2 className="mb-2" style={{ color: '#002d62' }}>WELCOME</h2>
                            <p className="mb-4" style={{ color: '#002d62' }}>LOG IN TO CONTINUE</p>
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <p 
                                    className="mt-3" 
                                    style={{ fontSize: '0.8em', color: '#002d62', cursor: 'pointer', textDecoration: 'underline' }}
                                >
                                    Forgot Password?
                                </p>
                            </form>
